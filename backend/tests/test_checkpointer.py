...
class TestAsyncCheckpointer:
    ...
    @pytest.mark.anyio
    async def test_postgres_uses_async_connection_pool(self):
        """Async Postgres setup should use a pool, not one long-lived connection."""
        from deerflow.runtime.checkpointer.async_provider import make_checkpointer
        ...
        assert kwargs["conninfo"] == "postgresql://localhost/db"
