...
def test_get_skills_prompt_section_waits_for_cold_enabled_skills_cache(monkeypatch):
    prompt_module._get_cached_skills_prompt_section.cache_clear()
    monkeypatch.setattr(prompt_module, "_enabled_skills_cache", None)
    monkeypatch.setattr(prompt_module, "_enabled_skills_refresh_active", False)
    monkeypatch.setattr(prompt_module, "_enabled_skills_refresh_version", 0)
    prompt_module._enabled_skills_refresh_event.clear()
    monkeypatch.setattr(prompt_module, "_load_enabled_skills_sync", lambda: [_make_skill("skill1")])
