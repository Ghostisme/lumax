  ...
  return (
    <>
      <SidebarGroup className="pt-2.5">
        <SidebarGroupLabel className="px-2 text-[11px] tracking-wide uppercase text-[var(--chat-text-soft)]/92">
                        ...
                        {env.NEXT_PUBLIC_STATIC_WEBSITE_ONLY !== "true" && (
                          <DropdownMenu>
                            <DropdownMenuTrigger asChild>
                              <SidebarMenuAction
                                showOnHover
                                className="rounded-lg bg-transparent text-[var(--chat-text-soft)] hover:bg-[var(--chat-sidebar-item-hover)] hover:text-[var(--chat-text-title)]"
                              >
                                <MoreHorizontal />
