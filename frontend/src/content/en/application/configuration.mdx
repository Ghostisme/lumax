...
| `NEXT_PUBLIC_BACKEND_BASE_URL`      | Optional | Override the backend API base URL for the frontend               |
| `NEXT_PUBLIC_AUTH_API_BASE_URL`     | Optional | Override the authentication API base URL                         |
| `NEXT_PUBLIC_LANGGRAPH_BASE_URL`    | Optional | Override the LangGraph API base URL                              |
| `NEXT_PUBLIC_STATIC_WEBSITE_ONLY`   | Optional | Enable static website mode                                       |
