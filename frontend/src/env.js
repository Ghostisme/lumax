...
export const env = createEnv({
  ...
  client: {
    ...
    NEXT_PUBLIC_AUTH_API_BASE_URL: z.string().optional(),
    NEXT_PUBLIC_FIGMA_ASSET_BASE_URL: z.string().optional(),
  ...
  runtimeEnv: {
    ...
    NEXT_PUBLIC_FIGMA_ASSET_BASE_URL:
      process.env.NEXT_PUBLIC_FIGMA_ASSET_BASE_URL,
